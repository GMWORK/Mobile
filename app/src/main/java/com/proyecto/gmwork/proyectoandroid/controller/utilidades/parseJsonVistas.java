...
public class parseJsonVistas {
    public static ArrayList parseCategoriaLog(String s) throws JSONException {
    ...
    public static ArrayList parsePedidoproductoLog(String s) throws JSONException {
        ArrayList list = new ArrayList();
        JSONArray array = new JSONArray(s);
    ...
    public static ArrayList parseUsuarioLog(String s) throws JSONException {
        ArrayList list = new ArrayList();
        JSONArray array = new JSONArray(s);
    ...
    public static ArrayList parseClienteLog(String s) throws JSONException {
        ArrayList list = new ArrayList();
        JSONArray array = new JSONArray(s);
    ...
    public static  ArrayList parseProductoVista(String s) throws JSONException {
        ArrayList list = new ArrayList();
        JSONArray array = new JSONArray(s);
        for (int i = 0; i < array.length(); i++) {
            JSONObject object = array.getJSONObject(i);
    ...
    public static ArrayList parsePedido(String s) throws JSONException {
        ArrayList list = new ArrayList();
        JSONArray array = new JSONArray(s);
        for (int i = 0; i < array.length(); i++) {
            JSONObject object = array.getJSONObject(i);
